...
--
-- This script contains changes to step 7 to support Keycloak realm roles:
--   * realm roles are used instead of scopes
--   * realm roles are returned as table and have to be converted to string
--
...
function jwtverify(txn)
    ...
    if token.payloaddecoded.realm_access ~= nil then
      ...
      txn.set_var(txn, "txn.oauth_roles", roles)
    else
      txn.set_var(txn, "txn.oauth_roles", "")
    end
